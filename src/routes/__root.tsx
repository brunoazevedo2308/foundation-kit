...
function RootComponent() {
  ...
  useEffect(() => {
    if (!supabase) return;
    // Keep router + query cache in sync with the Supabase session.
    // Filter to identity transitions so we don't thrash on TOKEN_REFRESHED
    // (~hourly / on tab focus) or INITIAL_SESSION (every mount).
