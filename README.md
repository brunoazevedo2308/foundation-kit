...
- **Attachments**: desbloqueado na US-008 — bucket privado dedicado `attachments-private` (25 MiB) aplicado no Development. Ver a seção "Anexos (US-008)" abaixo e `docs/attachments-storage-gap.md`.
...
- **Attachments**: ~~bloqueio de bucket/policies~~ **resolvido na US-008** (migration `20260828143000_us008_attachments_private_bucket.sql`, já aplicada no Development).
